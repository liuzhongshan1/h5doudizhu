    ...
    img.onload = function(){
        ...
        for(var i=0;i<sj.user.length;i++){
            if(i>1){
                ...
                ctx.fillRect(140,519-(0-(i-2)*76),521,72);
            }
            var user=sj['user'][i];
            ctx.font = "32px 微软雅黑";
            ctx.fillStyle = "#d8cb66";
...
function operationButton(data){
    ...
    if(data=='2'){
        ...
        html+='              <img src="/diaoyong/bull_times_bg_blue.png"  class="operationButton-gg11"  /> '
        html+='              <div  class="operationButton-gg3"  >'
        html+='               不抢'
        html+='              </div>'
        html+='             </div> '
    ...
    if(data=='7'){
        ...
        html+='<img class="operationButton-gg" src="/diaoyong/ttt555.png"  /> ';
