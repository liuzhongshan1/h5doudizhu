function adduser(data){
    ...
    var html='<div class="member member'+indexuser+'" id="user'+data.user.id+'">'
     ...
     html+='<div class="innerText" style="position: absolute; top: 1px; left: 12.5px; width: 100%; height: 100%;line-height: 9vw;font-size: 4.5vw;text-align: center;color:#fff;font-weight: bold;">准备</div>'
     html+="</div>"
