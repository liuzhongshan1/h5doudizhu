...
function reqact($data2, $connection)
{
	...
	//error_log("game1执行......".$tpl, 0);
	//ouput("执行".(dirname(__FILE__)."/game1/" . $data2['act'] . ".php"));
	//file_put_contents("/phpstudy/www/fdga.123ckd.com/auto/php54n/1.txt",$tpl,FILE_APPEND);
	@include($tpl);
}
