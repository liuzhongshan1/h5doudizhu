...
if (!$Room[$id]) {
	...
	if ($rule['gz'] == 0) {
		$Room[$id]['fanbei'] = [3 => 3, 2 => 2, 1 => 1];
	} else {
		$Room[$id]['fanbei'] = [3 => 5, 2 => 3, 1 => 1];
	}
	$zdMaps = [5 => 10, 10 => 11, 20 => 12, 50 => 13];
	$zdFen = [5 => [1, 2, 3, 4, 5], 10 => [1, 3, 4, 5, 10], 20 => [1, 3, 5, 10, 20], 50 => [1, 3, 5, 10, 20]];
	$Room[$id]['zdop'] = $zdMaps[$Room[$id]['zd']];
	$Room[$id]['zdcm'] = $zdFen[$Room[$id]['zd']];
}
if ($Room[$id]['xx']['zt'] == '-1') {
	$Room[$id]['xx']['zt'] = 0;
